...
def webpage():
    ...
    <h1>Use this button as a stopwatch:</h1><br>
    <form accept-charset="utf-8" method="POST">
    <button class="button" name="LAP" value="LAP" type="submit">LAP</button></a></p></form>
    <br>
    <p class="dotted">The time since this button was last pressed is
    <span style="color: deeppink;">{dt} {time_unit}</span></p><br>
    </body></html>
    """
    return html
...
def buttonpress(request: HTTPRequest):
    ...
    #  reload site
    if "LAP" in raw_text:
        #  record the amound of time passed
        try:
            global t
            global dt
            start_time = t

...
class Plotter:
    def __init__(self, ax):
        ...
        self.ax.set_ylim(-2, 2) # +/-2g is what our accelerometer's resolution is set to.
...
fig.canvas.manager.set_window_title('Plot Acceleration Data [-2-2g]')
fig.tight_layout()
plt.show()